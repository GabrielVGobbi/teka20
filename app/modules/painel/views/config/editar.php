			...
			<div class="tab-pane active" id="tab_dados">
				...
				<div class="row">
					<div class="col-md-3">
						...
						<img  class="profile-user-img img-responsive" src="<?php echo BASE_URL ?>app/assets/images/clientes/<?php echo $nomecliente ?>/<?php echo $nomecliente ?>_user.jpg" alt="User profile picture">
